...
router.post('/generate-domain', async (req, res) => {
    try {
        ...
        await db_1.default.run('INSERT INTO tech_domains (code, name, icon, description) VALUES (?, ?, ?, ?)', [domainInfo.code, domainInfo.name, domainInfo.icon, domainInfo.description]);
